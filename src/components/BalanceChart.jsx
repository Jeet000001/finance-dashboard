  ...
  if (active && payload && payload.length) {
    return (
      <div className="rounded-xl px-4 py-3 text-sm bg-[#221f35] border border-[#2d2a45]">
        <p className="font-bold mb-2 text-[#e8e6f0]">{label} 2025</p>
      ...
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex gap-4 text-xs">
          <span className="flex items-center gap-1.5 text-green-500">
            <span className="w-3 h-0.5 inline-block rounded bg-green-500"></span>
            Income
          </span>

          <span className="flex items-center gap-1.5 text-red-500">
            <span className="w-3 h-0.5 inline-block rounded bg-red-500"></span>
            Expenses
          </span>

          <span className="flex items-center gap-1.5 text-violet-500">
            <span className="w-3 h-0.5 inline-block rounded bg-violet-500"></span>
            Balance
          </span>
        </div>
      </div>
